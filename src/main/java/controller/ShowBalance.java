...
public class ShowBalance extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // In questo caso questo controllo è necessario: nel progetto va sempre fatto il doppio controllo (sia lato client che lato server) come fatto in questa applicazione
        int customerId=0;
        try {
